...
import 'package:proje/components/product_card.dart';
import 'package:proje/constant/constant.dart';
import 'package:proje/model/home_products_model.dart';
import 'package:proje/riverpod/home_riverpod.dart';
...
class _HomeState extends ConsumerState<Home> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: watch.campaingsCurrentIndex == i 
                            ? Constant.white 
                            : Constant.gray,
  ...
  PageView campaignsPageView(HomeRiverpod read, HomeRiverpod watch) {
    return PageView.builder(
              ...
              itemBuilder: (context, index) => Image.asset(watch.campaigns[index], fit: BoxFit.cover,),
